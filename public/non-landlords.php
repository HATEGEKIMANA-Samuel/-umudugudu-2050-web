                ...
                <div class="tab-content">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3 pt-10">
                            <span class="pt-15" style="margin-left: 1%;"><small class="fs-14">Igiteranyo: <span class="badge bg-primary" id='total-found'></span></small></span>
                        </div>
                    ...
                    <table class="table mt-20 table-striped">
                        ...
                        <tbody class="old_content">
                            ...
                            $query = "SELECT * FROM (SELECT 
                                    ...
                                    d.documentNumber as document_id,d.dob $column,is_family_heading as tb from citizen d 
                                    where  d.is_family_heading='1' AND  d.landLord  is null ) AS data WHERE {$l['value']}";
                            $people = $database->query($query);
                            ob_start();
                            while ($diplomat = $database->fetch_array($people)) { ?>
                                <tr>
                                    <td scope='row' class='numbering'><?= $i ?></td>
                                    <td><span class="text-capitalize fw-600"><?= $diplomat['given_name'] . ' ' . $diplomat['family_name'] . ' ' . $diplomat['other_name']  ?></span></td>
