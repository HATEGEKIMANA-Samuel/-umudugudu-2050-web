                ...
                <div class="tab-content">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            $total_found = family::getAllPeople($database, $location, 0, "WHERE 1 " . $search);
                            ?>
                        </div>
                    </div>
                    ...
                    <table class="table mt-20 table-striped">
                        ...
                        <tbody class="old_content">
                            ...
                            $people = family::getAllPeople($database, $location, $limit, " WHERE 1 " . $search);
                            ob_start();
                            foreach ($people as $key => $diplomat) { ?>
                                <tr>
                                    <td scope='row' class='numbering'><?= $i ?></td>
                                    <td><span class="text-capitalize d-block"><?= $diplomat['givenName'] . ' ' . $diplomat['familyName'] . ' ' . $diplomat['otherName'] ?></span>
                                        &nbsp;<?= $diplomat["tb"] == "1" ? "<span class='text-primary fs-14'>Umukuru w'umuryango</span>" : "" ?>
                                    </td>
                                    <?php if ($level == 2) : ?>
