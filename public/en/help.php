		...
		<div class="content mt-10">
			...
			<div class="col-lg-12">
				<div style="display: inherit; padding-bottom: 30px;" class="card">
					...
					echo "<li class='list-group-item info-list'><div class='labels'>Help </div><div class='datas'>{$help_rcv}</div></li>";
					echo "<li class='list-group-item info-list'><div class='labels'>Giver</div><div class='datas'>{$giver}</div></li>";
					...
					echo "<li class='list-group-item info-list'><div class='labels'>Comment</div><div class='datas'>{$spouse['comment']}</div></li>";
					...
					<button class="btn btn-primary w-150 mb-20" id="comment_button" type="button" onclick="myFunction(this)" title='Write a comment'><i class="fa fa-comments-o fa-2x" aria-hidden="true"></i> Write a comment</button>
					<center>
