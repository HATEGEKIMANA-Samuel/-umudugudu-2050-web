...
try {
  $query = "UPDATE citizen SET  number_of_rent_house ='{$rh["number_of_rent_house"]}', landLord ='{$rh["landLord"]}', updated_at = '$date', is_family_heading ='$is_family_heading', familyCategory='$familyCategory', familyId='$familyId' WHERE citizenId = '$replacer'";
