                    ...
                    <div class="tab-content-body">
                        <div class="row m-10 ">
                            <div class="col-md-12 pl-0 fw-500 mb-20">
                                ...
                                <small class="fs-14">
                                    <?= $found_result ?> Found results(<?= $locname ?>)</small>
                            </div>
                            <?php
                            if ($found_result != 0) {
                                $limit = 0;
                            ...
                            ?>
                                    ...
                                    <div class="col-md-12 mb-10" style="background-color: #f4f7fd; padding: 20px;border-left: 4px solid #6a005b">
                                        <a href="<?= $href ?>" class="text-dark">
                                            <h3><?= $diplomat['given_name'] . ' ' . $diplomat['family_name'] . ' ' . $diplomat['other_name'] . ' ' . $diplomat['dob'] ?></h3>
                                            <small><?= $diplomat['document_id'] ?></small>
                                        </a>
                                    </div>
                                <?php
                                ...
                                <div class="col-md-12 mb-3 text-center" style="background-color: #fff; color: #ef2b2b">
                                    ...
                                    <small class="text-dark">Trying searching again</small>
                                </div>
                            <?php
                            }
                            ?>
